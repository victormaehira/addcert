...
class TokenSession: TKTokenSession, TKTokenSessionDelegate {
    ...
    static let privateKeyPassword = "12345678"
    ...
    //private key Victor Yuji Maehira corporativo sem senha
    /*
    static let privateKey = ""
     */
    ...
    private static func getPrivateSecKey() throws -> SecKey {
        ...
        keyParams.passphrase = Unmanaged.passRetained(privateKeyPassword as CFTypeRef)
        ...
        guard status == errSecSuccess,
              ...
              CFArrayGetCount(importedItems) > 0 else {
            throw NSError(domain: "CertTokenExtension", code: Int(status), userInfo: [
                NSLocalizedDescriptionKey: "Failed to import encrypted private key (status: \(status))"
            ])
        }
